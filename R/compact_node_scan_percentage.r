...
raw_pb<-c(147,2141,84,923,29,453,21,357,
          12,231,
          4,86,
          6,121,
          13,206,
...
png(path_result, width=2400,height=1000,unit="px")
...
bb<-barplot(matrix_pb,ylim=c(0,2500))
...
text(bb,matrix_pb[1,]+50,labels=paste(legends,"%",sep=""),cex=2)
text(bb,colSums(matrix_pb)+100,labels=matrix_pb[1,]+matrix_pb[2,],cex=2)
